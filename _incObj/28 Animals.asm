...
Anml_FromEnemy:
	...
	.setupAnimal:
		...
		move.l	#Points,(v_points+obID).w		; load points object
		move.w	obX(a0),(v_points+obX).w		; copy X-position
		move.w	obY(a0),(v_points+obY).w		; copy Y-position
		...
		move.b	d0,(v_points+obFrame).w			; set result as points frame ID (100, 200, 500, 1000...)
