...
ExItem_Main:	; set directly for non-Badnik objects (e.g. monitors)
		move.l	#ExItem_Animate,obID(a0)		; advance to ExItem_Animate
...
Explosion:
		move.l	#ExItem_Animate,obID(a0)		; advance to ExItem_Animate (foreign object)
